...
```
    ...
    Counties in state Wisconsin have an average population of 78985.9166667
    Counties in state Wyoming have an average population of 24505.4782609
    1.91 s ± 80.6 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
```
    ...
    Counties in state Wisconsin have an average population of 78985.9166667
    Counties in state Wyoming have an average population of 24505.4782609
    49.9 ms ± 546 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
```
    ...
    <ipython-input-70-6f05ac150564> in <module>()
    ----> 1 df = df.set_index('STNAME')
          2 
          3 def fun(item):
          4     if item[0]<'M':
          5         return 0
    ...
    /opt/conda/lib/python3.6/site-packages/pandas/core/frame.py in set_index(self, keys, drop, append, inplace, verify_integrity)
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f4786a6d1d0>
