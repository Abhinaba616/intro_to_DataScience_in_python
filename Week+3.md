...
```
    ...
    Alabama    Autauga County         54660.0
               ...
               Bullock County         10606.0
               Butler County          20154.0
               Calhoun County        115620.0
               Chambers County        33993.0
               Cherokee County        25859.0
               Chilton County         43665.0
               Choctaw County         13170.0
               Clarke County          24675.0
               Clay County            13456.0
               Cleburne County        14921.0
               Coffee County          50177.0
               Colbert County         54354.0
               Conecuh County         12662.0
               Coosa County           10724.0
               Covington County       37796.0
               Crenshaw County        13853.0
               Cullman County         80374.0
               Dale County            49501.0
               Dallas County          41131.0
               DeKalb County          70869.0
               Elmore County          79465.0
               Escambia County        37784.0
               Etowah County         103057.0
               Fayette County         16759.0
               Franklin County        31507.0
                                       ...   
    Wisconsin  Washburn County        15552.0
               Washington County     131967.0
               Waukesha County       390076.0
               Waupaca County         51945.0
               Waushara County        24033.0
               Winnebago County      167059.0
               Wood County            73435.0
    Wyoming    Albany County          36428.0
               Big Horn County        11672.0
               Campbell County        46244.0
               Carbon County          15559.0
               Converse County        13728.0
               Crook County            7114.0
               Fremont County         40222.0
               Goshen County          13383.0
               Hot Springs County      4741.0
               Johnson County          8552.0
               Laramie County         92271.0
               Lincoln County         17943.0
               Natrona County         75472.0
               Niobrara County         2475.0
               Park County            28259.0
               Platte County           8678.0
               Sheridan County        29146.0
               Sublette County         9899.0
               Sweetwater County      43593.0
...
```
    ...
    <ipython-input-26-0f9173bcb790> in <module>()
    ----> 1 get_ipython().run_cell_magic('timeit', '-n 10', "for state in df['STNAME'].unique():\n    avg = np.average(df.where(df['STNAME']==state).dropna()['CENSUS2010POP'])\n    print('Counties in state ' + state + ' have an average population of ' + str(avg))")
    ...
    /opt/conda/lib/python3.6/site-packages/IPython/core/magics/execution.py in timeit(self, line, cell)
       1082                     break
       1083 
    ...
    /opt/conda/lib/python3.6/timeit.py in repeat(self, repeat, number)
        204         r = []
    ...
    /opt/conda/lib/python3.6/site-packages/IPython/core/magics/execution.py in timeit(self, number)
        158         gc.disable()
        159         try:
    ...
    /opt/conda/lib/python3.6/site-packages/pandas/core/generic.py in where(self, cond, other, inplace, axis, level, try_cast, raise_on_error)
       4811         other = com._apply_if_callable(other, self)
       4812         return self._where(cond, other, inplace, axis, level, try_cast,
    -> 4813                            raise_on_error)
       4814 
       4815     @Appender(_shared_docs['where'] % dict(_shared_doc_kwargs, cond="False",


    /opt/conda/lib/python3.6/site-packages/pandas/core/generic.py in _where(self, cond, other, inplace, axis, level, try_cast, raise_on_error)
       4706                                         raise_on_error=raise_on_error,
       4707                                         try_cast=try_cast, axis=block_axis,
    -> 4708                                         transpose=self._AXIS_REVERSED)
       4709 
       4710             return self._constructor(new_data).__finalize__(self)


    /opt/conda/lib/python3.6/site-packages/pandas/core/internals.py in where(self, **kwargs)
       3157 
       3158     def where(self, **kwargs):
    -> 3159         return self.apply('where', **kwargs)
       3160 
       3161     def eval(self, **kwargs):
    ...
    /opt/conda/lib/python3.6/site-packages/pandas/core/internals.py in _consolidate_inplace(self)
       3529     def _consolidate_inplace(self):
       3530         if not self.is_consolidated():
    -> 3531             self.blocks = tuple(_consolidate(self.blocks))
       3532             self._is_consolidated = True
       3533             self._known_consolidated = True


    /opt/conda/lib/python3.6/site-packages/pandas/core/internals.py in _consolidate(blocks)
       4521     for (_can_consolidate, dtype), group_blocks in grouper:
       4522         merged_blocks = _merge_blocks(list(group_blocks), dtype=dtype,
    -> 4523                                       _can_consolidate=_can_consolidate)
       4524         new_blocks = _extend_blocks(merged_blocks, new_blocks)
       4525     return new_blocks


    /opt/conda/lib/python3.6/site-packages/pandas/core/internals.py in _merge_blocks(blocks, dtype, _can_consolidate)
       4544 
       4545         argsort = np.argsort(new_mgr_locs)
    -> 4546         new_values = new_values[argsort]
       4547         new_mgr_locs = new_mgr_locs[argsort]
       4548 
...
```
    ...
    Counties in state Wisconsin have an average population of 78985.9166667
    Counties in state Wyoming have an average population of 24505.4782609
    53.1 ms ± 4.04 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
